                ...
                <div className="grid gap-4 xl:grid-cols-3">
                    ...
                    <div className="xl:col-span-2 rounded-lg border border-slate-800 bg-slate-900/60 p-5">
                        ...
                        <div className="mt-4">
                            <MarketDataPanel
                                ...
                                handleOrderbookPriceClick={quickActions.handleOrderbookPriceClick}
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-4 rounded-lg border border-slate-800 bg-slate-900/60 p-5">
                        ...
                        <div className="space-y-4">
                            <div>
                                <h4 className="mb-2 text-sm font-semibold text-slate-300">Позиции</h4>
                                <PositionsTable
                            ...
                            <div>
                                <h4 className="mb-2 text-sm font-semibold text-slate-300">Ордера</h4>
