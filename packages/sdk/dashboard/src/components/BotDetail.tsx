    ...
    <div className="bot-detail">
      ...
      <div className="grid">
        ...
        <div className="card">
          ...
          <div className="stat-label">{bot.info.strategy || 'No strategy'}</div>
        </div>
              ...
              bot.trades.map((trade, idx) => (
                <div key={idx} className="feed-item">
                  ...
                  <div className="feed-content">
                    {formatBigInt(trade.qty, 5)} @{' '}
                    {formatBigInt(trade.price, 2)}
                  </div>
                </div>
              ))
            )}
            ...
            {bot.fills.length === 0 ? (
              ...
              bot.fills.map((fill, idx) => (
                <div key={idx} className="feed-item">
                  ...
                  <div className="feed-content">
                    Order {fill.orderId.substring(0, 8)}:{' '}
                    {formatBigInt(fill.qty, 5)} @ {formatBigInt(fill.price, 2)}
                  </div>
                </div>
              ))
            )}
